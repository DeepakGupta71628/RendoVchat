...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void saveUserData(){
        ...
        if(ImageUri==null){
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).hasChild("image")){
                        ...
                        Toast.makeText(SettingsActivity.this, "Hey, Pelese Select Image First", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(this, "UserBio is mandatory", Toast.LENGTH_SHORT).show();
        }
        else {
