            ...
            public void onClick(View v) {
                if(continueAndNextBtn.getText().equals("submit") || checker.equals("Code Sent")){
                    ...
                    if(verificationCode.equals("")){
                        ...
                        loadingBar.setMessage("please wait ,while we are verifiing your phone number");
                    ...
                    if(!phoneNumber.equals("")){
                        ...
                        Toast.makeText(RegistrationActivity.this,"Please write valide phone number",Toast.LENGTH_SHORT);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                          loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratulation", Toast.LENGTH_SHORT).show();
